...
func _process(delta: float) -> void:
	target.global_position = ship_rb.global_position + ship_rb.global_basis.y * 0.6 + ship_rb.global_basis.z * 0.8
	target.look_at(ship_rb.global_position - ship_rb.global_basis.z * 20, ship_rb.global_basis.y)

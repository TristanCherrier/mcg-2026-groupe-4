...
func award_level_finish() -> void:
	pass  # Plus de bonus au passage de niveau
...
func complete_level() -> void:
	...
	if next_level_path != "":
		...
		# Fin du jeu : victoire seulement si score positif
		if score > 0:
			open_victory()
		else:
			open_defeat("Vous avez termine le jeu mais avec un score negatif (%d). Essayez encore !" % score)
